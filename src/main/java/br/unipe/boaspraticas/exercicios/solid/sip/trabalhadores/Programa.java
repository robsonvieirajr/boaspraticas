...
class Programa {
    public static void main(String[] args) {
        TrabalhadorIntegral gerente = new Gerente();
        gerente.trabalharEmTempoIntegral();

        TrabalhadorTemporario gerenteTemporario = new Gerente();
        gerenteTemporario.fazerTrabalhoTemporario();

        TrabalhadorIntegral estagiario = new Estagiario();
